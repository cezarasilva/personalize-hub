...
-- =========================================================
-- PERSONALIZE HUB V3.9 - MÁQUINAS + PRECIFICAÇÃO POR LOTE
...
CREATE TABLE IF NOT EXISTS maquinas (
    ...
    modelo VARCHAR(150),
    tipo VARCHAR(80) DEFAULT 'OUTRA',
    valor_compra NUMERIC(10,2) DEFAULT 0,
    vida_util_horas NUMERIC(10,2) DEFAULT 0,
    potencia_kw NUMERIC(10,4) DEFAULT 0,
    valor_kwh NUMERIC(10,4) DEFAULT 0,
    custo_manutencao_hora NUMERIC(10,2) DEFAULT 0,
    custo_depreciacao_hora NUMERIC(10,4) DEFAULT 0,
    custo_energia_hora NUMERIC(10,4) DEFAULT 0,
    custo_total_hora NUMERIC(10,4) DEFAULT 0,
    custo_hora_manual NUMERIC(10,2),
    usar_custo_manual BOOLEAN DEFAULT false,
    status VARCHAR(20) DEFAULT 'ATIVA',
    criado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    atualizado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS nome VARCHAR(150);
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS modelo VARCHAR(150);
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS tipo VARCHAR(80) DEFAULT 'OUTRA';
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS valor_compra NUMERIC(10,2) DEFAULT 0;
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS vida_util_horas NUMERIC(10,2) DEFAULT 0;
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS potencia_kw NUMERIC(10,4) DEFAULT 0;
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS valor_kwh NUMERIC(10,4) DEFAULT 0;
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS custo_manutencao_hora NUMERIC(10,2) DEFAULT 0;
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS custo_depreciacao_hora NUMERIC(10,4) DEFAULT 0;
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS custo_energia_hora NUMERIC(10,4) DEFAULT 0;
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS custo_total_hora NUMERIC(10,4) DEFAULT 0;
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS custo_hora_manual NUMERIC(10,2);
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS usar_custo_manual BOOLEAN DEFAULT false;
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS status VARCHAR(20) DEFAULT 'ATIVA';
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS criado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE maquinas ADD COLUMN IF NOT EXISTS atualizado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
...
-- Precificação por lote / unidade e vínculo com máquina
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS quantidade_produzida INTEGER DEFAULT 1;
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS unidade_precificacao VARCHAR(30) DEFAULT 'UNIDADE';
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS custo_total_producao NUMERIC(10,2) DEFAULT 0;
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS custo_unitario NUMERIC(10,2) DEFAULT 0;
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS preco_sugerido_unitario NUMERIC(10,2) DEFAULT 0;
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS preco_final_unitario NUMERIC(10,2) DEFAULT 0;
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS preco_total_lote NUMERIC(10,2) DEFAULT 0;
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS maquina_id INTEGER REFERENCES maquinas(id) ON DELETE SET NULL;
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS maquina_nome_snapshot VARCHAR(180);
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS custo_hora_maquina NUMERIC(10,2) DEFAULT 0;
ALTER TABLE precificacoes ADD COLUMN IF NOT EXISTS custo_total_maquina NUMERIC(10,2) DEFAULT 0;

CREATE INDEX IF NOT EXISTS idx_precificacoes_maquina_id ON precificacoes(maquina_id);
CREATE INDEX IF NOT EXISTS idx_precificacoes_produto_maquina ON precificacoes(produto_id, maquina_id);

-- Valores padrão úteis para preencher telas futuras
INSERT INTO configuracoes_precificacao (chave, valor, descricao)
VALUES
    ('valor_kwh_padrao', '0.90', 'Valor padrão do kWh de energia'),
    ('vida_util_horas_padrao', '20000', 'Vida útil padrão para cálculo de depreciação'),
    ('margem_padrao', '40', 'Margem padrão de precificação'),
    ('hora_maquina_manual_padrao', '1.00', 'Valor manual padrão de hora máquina')
ON CONFLICT (chave) DO NOTHING;
