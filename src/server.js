...
const { autenticar, somenteAdmin, normalizarPerfil, getBearerToken } = require('./middlewares/auth');
const { limiterLogin, limiterCatalogoPublico, limiterSenha } = require('./middlewares/rateLimiters');
const { validate, schemaLogin, schemaCadastrarParceiro, schemaSolicitarParceiro, schemaCriarProduto, schemaCriarUsuario, schemaRecuperarSenha, schemaResetSenha } = require('./middlewares/validate');
const {
    parseMoeda, toInt, money, calcularCustosMaquina, gerarCodigo, inicioFimMes,
    garantirParceiroPermitido, gerarSkuAutomatico, normalizarSku,
    ...
    salvarPrecificacaoProduto, csvEscape, toCSV
} = require('./helpers');
...
// =========================================================
// HELPERS — funções utilitárias agora em src/helpers/index.js
// =========================================================
...
app.post('/api/login', limiterLogin, validate(schemaLogin), async (req, res) => {
    try {
...
app.post('/api/usuarios/recuperar', limiterSenha, validate(schemaRecuperarSenha), async (req, res) => {
    try {
...
app.post('/api/parceiros', autenticar, somenteAdmin, validate(schemaCadastrarParceiro), async (req, res) => {
    try {
...
app.post('/api/parceiros/solicitar', validate(schemaSolicitarParceiro), async (req, res) => {
    try {
